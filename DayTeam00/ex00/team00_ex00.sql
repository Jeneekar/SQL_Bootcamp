CREATE TABLE IF NOT EXISTS ex00(
  point1 VARCHAR,
  point2 VARCHAR,
  cost INTEGER
);

INSERT INTO ex00(point1, point2, cost)
VALUES
  ('a', 'b', 10),
  ('b', 'a', 10),
  ('a', 'c', 15),
 ...
 SELECT cost_sum AS total_cost, points AS  tour FROM temp WHERE cost_sum = (SELECT MIN(cost_sum) FROM temp) 
